            ...
            if (entity != null) {
                ...
                try {
                    ...
                    for (int i = 0; i < resultsArray.length(); i++) {
                        ...
                        String stationName = station.optString("name", "Desconocida");
                        int availableBikes = station.optInt("available_bikes", 0);
                        int availableSpaces = station.optInt("available_bike_stands", 0);
                        
                        System.out.println("Estación: " + stationName);
                        System.out.println("Bicicletas disponibles: " + availableBikes);
                        System.out.println("Espacios disponibles: " + availableSpaces);
                        System.out.println("-----------------------------------");
                    }
