...
public class ConectaBBDD {
    ...
    public void conecta() throws SQLException {
        try {
            ...
            String jdbcUrl = "jdbc:mariadb://localhost:3308/empresa"; // o IP
    ...
    public int grabaRegistro(Articulo art) throws java.sql.SQLException {
        int ok = -1;
    ...
    public int modiRegistro(Articulo art) throws java.sql.SQLException  {
        int ok = -1;
